    ...
    var SERVICE_CONFIGS = {
        'netflix': {
            ...
            categories: [
                ...
                { "title": "Тільки на Netflix", "url": "discover/tv", "params": { "with_networks": IDS.NETFLIX, "with_status": "0|1|2|3", "sort_by": "vote_average.desc", "vote_count.gte": "500" } },
                { "title": "K-Dramas", "url": "discover/tv", "params": { "with_networks": IDS.NETFLIX, "with_original_language": "ko", "sort_by": "popularity.desc" } },
                { "title": "Аніме", "url": "discover/tv", "params": { "with_networks": IDS.NETFLIX, "with_genres": "16", "with_original_language": "ja", "sort_by": "popularity.desc" } },
        ...
        'disney': {
            ...
            categories: [
                ...
                { "title": "Star Wars", "url": "discover/tv", "params": { "with_companies": "1", "with_keywords": "1930", "sort_by": "popularity.desc" } },
        ...
        'educational_and_reality': {
            ...
            categories: [
                ...
                { "title": "Кулінарія", "url": "discover/tv", "params": { "with_genres": "10764", "with_keywords": "222083", "sort_by": "popularity.desc" } },
                { "title": "True Crime", "url": "discover/tv", "params": { "with_genres": "99", "with_keywords": "10714", "sort_by": "popularity.desc" } }
            ]
        }
    };
